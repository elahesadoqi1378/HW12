...
class Program
{
    ...
    private static void Register()
    {
            ...
            
        {
            ...
            bool input = userRepository.CheckUserExist(username);
            if (input)
            {
    ...
    private static void DisplayTasks()
    {
        ...
        {
            Console.WriteLine($"ID: {duty.Id}, Title: {duty.Title}, Due Date: {duty.TimeToDone}, Priority: {duty.Priority}, Status: {duty.State}");
        }
    }
